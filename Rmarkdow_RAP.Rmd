...
Il existe fête un événement où on peut voir les meilleurs athlètes de chaque pays pour participer dans plusieurs disciplines où ils rivalisent pour déterminer à la fin le meilleur de cette discipline. Cet événement, connu comme les Jeux Olympiques, a été célebré pour première fois en Athènes 1896. Tous les quatres ans nous attendions avec impacience voir combien d'athlètes représenteront notre pays et remporteront des medailles. Cependant, est-ce que vous avez déjà réfléchi à ce qui permet aux athlètes de gagner une médaille? Pour cela ce travail s'intéresse à analyser les facteurs déterminants des médailles des Jeux Olympiques.
...
vif(reg) jsp comment le mettrre helpppppppppppppppppp
